...
namespace Sales.API.Common.Errors;


public class SalesProblemDetailsFactory : ProblemDetailsFactory
{
    private readonly ApiBehaviorOptions _apiBehaviorOptions;

    public SalesProblemDetailsFactory(IOptions<ApiBehaviorOptions> apiBehaviorOptions)
    {
